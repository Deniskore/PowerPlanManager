...
NvAPI_Status GPU::ToggleNvidiaPerformanceMode(bool enablePerformanceMode) {
...
NvAPI_Status GPU::ToggleNvidiaAnsel(bool enableAnsel) {
  auto &session = NVDRSSession::GetInstance();
...
NvAPI_Status GPU::ToggleNvidiaVsync(bool enableVsync) {
...
// mode
NvAPI_Status GPU::NvidiaLowLatencyModeCPL(GPULatencyType latencyState) {
  auto &session = NVDRSSession::GetInstance();
...
NvAPI_Status GPU::NvidiaSetDigitalVibrance(int desiredDVLevel) {
  auto &session = NVDRSSession::GetInstance();
...
NvAPI_Status GPU::NvidiaMaxPrerenderedFrames(int maxPrerenderedFrames) {
  auto &session = NVDRSSession::GetInstance();
...
NvAPI_Status GPU::ToggleNvidiaLowLatencyMode(bool enableLowLatencyMode) {
...
NvAPI_Status GPU::ToggleNvidiaUltraLowLatencyMode(bool enableLowLatencyMode) {
